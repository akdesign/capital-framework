...
var closest = require( 'atomic-component/utilities/dom-closest' ).closest;
var config = require( 'atomic-component/utilities/config' );
var Organism = require( 'atomic-component/components/organisms/Organism' );
